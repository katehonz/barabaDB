...
import ../../queries/baradb/add_column
import ../../queries/baradb/change_column
import ../../queries/baradb/rename_column
import ../../queries/baradb/drop_column
import ../../queries/baradb/rename_table

proc alter*(rdb: BaradbConnections, tables: varargs[Table]) =
